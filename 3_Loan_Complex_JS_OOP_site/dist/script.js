...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, active, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, active, animate, autoplay));
  }
